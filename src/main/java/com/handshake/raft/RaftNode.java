...
import com.handshake.raft.exception.RaftRemotingException;
import com.handshake.raft.rpc.*;
...
import static com.handshake.raft.NodeStatus.LEADER;
import static java.util.concurrent.TimeUnit.MILLISECONDS;

@Getter
@Setter
@Slf4j
public class RaftNode implements Node,ClusterMembershipChanges{
    ...
    private static class DefaultNodeLazyHolder {
        ...
        private static final RaftNode INSTANCE = new RaftNode();
    }
    @Override
